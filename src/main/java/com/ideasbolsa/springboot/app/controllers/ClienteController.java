...
public class ClienteController {
	...
	public String listar(@RequestParam(name = "page", defaultValue = "0") int page, Model model,
		...
		if (auth != null) {
			...
			logger.info("Utilizando forma estática SecurityContextHolder.getContext().getAuthentication(): Usuario identificado,  tu username es: ".concat(authentication.getName()));
